...
export async function POST(req: NextRequest) {
  try {
    ...
    if (status === 'PAID' || status === 'SETTLED') {
      ...
      if (authError) {
        console.error("ERROR - Gagal membuat user auth:", authError.message);
      }
      ...
      if (updateSuccess) {
        ...
        const adminPhoneRaw = '6285770916736'; 
        const cleanAdminPhone = adminPhoneRaw.replace(/\D/g, '');
              ...
              html: `
                <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: auto; border: 1px solid #eee; padding: 25px; border-radius: 12px;">
                  ...
                  <div style="text-align: center; margin-top: 20px;">
                    <a href="https://wa.me/${cleanAdminPhone}" 
              ...
              html: `
                <div style="font-family: sans-serif; max-width: 600px; margin: auto; border: 1px solid #eee; padding: 25px; border-radius: 12px; color: #333;">
                  ...
                  <div style="text-align: center; margin: 30px 0;">
                    ...
                    <a href="https://wa.me/${cleanAdminPhone}?text=Halo%20Admin%20SamaLoop,%20saya%20ingin%20konfirmasi%20inkuiri%20dari%20${encodeURIComponent(reg.name)}" 
                       style="background-color: #25D366; color: white; padding: 12px 25px; text-decoration: none; border-radius: 8px; font-weight: bold; display: inline-block;">
                       Hubungi Admin via WhatsApp
                    </a>
                  </div>
    ...
    console.error("FATAL ERROR - Webhook handler failed:", err?.message || err);
