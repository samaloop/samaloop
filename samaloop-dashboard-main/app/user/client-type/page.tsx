...
export default function PlacementList() {
  ...
  const data = useSWR("/api/client-types/list", fetcher);
  ...
  const handleDeleteClick = async (id: any) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        await supabase.from("client_types").delete().eq("id", id);
  ...
  return (
    <Row>
      <PageHeading heading="Client Types" />
