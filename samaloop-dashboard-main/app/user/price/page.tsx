...
export default function PlacementList() {
  ...
  const data = useSWR("/api/prices/list", fetcher);
          ...
          <Card.Body>
            <div className="d-md-flex justify-content-between align-items-center border-bottom pb-4 mb-4">
              ...
              <div className="text-center text-md-start">
                <Link href="/user/price/create" className="btn btn-primary">
                  Create
                </Link>
              </div>
            </div>
                  ...
                  data.data.data.map((value: any, index: number) => (
                    <tr key={"data" + index}>
                      ...
                      <td>
                        <Link
                          href={
                            "/user/price/update/" + encodeURIComponent(value.id)
                          }
                          className="text-dark"
                        >
